# 🧠 Klurigo Service Stack

This stack defines two deployment variants (`beta` and `prod`) for the backend API of the Klurigo game platform, built with NestJS. It supports real-time updates via Server-Sent Events (SSE), integrates with Redis and MongoDB, and fetches media from Pexels.

## 🐳 Service Overview

- **Image**: `emils-nuc-server:5000/klurigo-service:<tag>`
...
- **Uploads Volume**: `beta-klurigo-service-uploads-volume`

### Production Deployment
- **Compose file**: `docker-compose.prod.yaml`
- **Allowed Origins**: `https://klurigo.com`
- **Redis DB**: `0`
- **MongoDB DB**: `klurigo_prod`
- **Uploads Volume**: `prod-klurigo-service-uploads-volume`

> Make sure `core-network`, MongoDB, and Redis services are up and accessible by their hostnames (`mongodb`, `redis`).

---

> This service handles game logic, player interactions, and real-time event delivery for the full-stack Klurigo platform.
